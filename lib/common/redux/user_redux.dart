...
class UserInfoMiddleware implements MiddlewareClass<LYYJState> {

  @override
  void call(Store<LYYJState> store, dynamic action, NextDispatcher next) {
...
class UserInfoEpic implements EpicClass<LYYJState> {
  @override
  Stream<dynamic> call(Stream<dynamic> actions, EpicStore<LYYJState> store) {
  ...
  Stream<dynamic> _loadUserInfo() async* {
    ...
    // TODO
    var res = await /*UserDao.getUserInfo(null)*/ null;
